...
class CreditNote implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreditNote';
...
'tipo_nota' => 'getTipoNota'    ];
    ...
    const TIPO_NOTA_ANULACION_DE_LA_OPERACION = 'ANULACION_DE_LA_OPERACION';
const TIPO_NOTA__01 = '01';
const TIPO_NOTA_ANULACION_POR_ERROR_EN_EL_RUC = 'ANULACION_POR_ERROR_EN_EL_RUC';
const TIPO_NOTA__02 = '02';
const TIPO_NOTA_CORRECCION_POR_ERROR_EN_LA_DESCRIPCION = 'CORRECCION_POR_ERROR_EN_LA_DESCRIPCION';
const TIPO_NOTA__03 = '03';
const TIPO_NOTA_DESCUENTO_GLOBAL = 'DESCUENTO_GLOBAL';
const TIPO_NOTA__04 = '04';
const TIPO_NOTA_DESCUENTO_POR_ITEM = 'DESCUENTO_POR_ITEM';
const TIPO_NOTA__05 = '05';
const TIPO_NOTA_DEVOLUCION_TOTAL = 'DEVOLUCION_TOTAL';
const TIPO_NOTA__06 = '06';
const TIPO_NOTA_DEVOLUCION_POR_ITEM = 'DEVOLUCION_POR_ITEM';
const TIPO_NOTA__07 = '07';
const TIPO_NOTA_BONIFICACION = 'BONIFICACION';
const TIPO_NOTA__08 = '08';
const TIPO_NOTA_DISMINUCION_EN_EL_VALOR = 'DISMINUCION_EN_EL_VALOR';
const TIPO_NOTA__09 = '09';
const TIPO_NOTA_OTROS_CONCEPTOS = 'OTROS_CONCEPTOS';
const TIPO_NOTA__10 = '10';
    ...
    {
        return [
            self::TIPO_NOTA_ANULACION_DE_LA_OPERACION,
self::TIPO_NOTA__01,
self::TIPO_NOTA_ANULACION_POR_ERROR_EN_EL_RUC,
self::TIPO_NOTA__02,
self::TIPO_NOTA_CORRECCION_POR_ERROR_EN_LA_DESCRIPCION,
self::TIPO_NOTA__03,
self::TIPO_NOTA_DESCUENTO_GLOBAL,
self::TIPO_NOTA__04,
self::TIPO_NOTA_DESCUENTO_POR_ITEM,
self::TIPO_NOTA__05,
self::TIPO_NOTA_DEVOLUCION_TOTAL,
self::TIPO_NOTA__06,
self::TIPO_NOTA_DEVOLUCION_POR_ITEM,
self::TIPO_NOTA__07,
self::TIPO_NOTA_BONIFICACION,
self::TIPO_NOTA__08,
self::TIPO_NOTA_DISMINUCION_EN_EL_VALOR,
self::TIPO_NOTA__09,
self::TIPO_NOTA_OTROS_CONCEPTOS,
self::TIPO_NOTA__10,        ];
    }
     ...
     * Sets tipo_nota
     *
     * @param string $tipo_nota Catalogo 09
     *
     * @return $this
     */
