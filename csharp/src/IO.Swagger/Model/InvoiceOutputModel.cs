...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class InvoiceOutputModel :  IEquatable<InvoiceOutputModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceOutputModel" /> class.
        /// </summary>
        ...
        /// <param name="tipoInvoice">tipoInvoice (required).</param>
        public InvoiceOutputModel( cliente = default(),  detalle = default(), string fechaEmision = default(string),  firmante = default(), string horaEmision = default(string),  impuestos = default(), string moneda = default(string),  proveedor = default(), string serieNumero = default(string),  totales = default(),  tipoInvoice = default())
        {
            // to ensure "cliente" is required (not null)
            if (cliente == null)
            {
                throw new InvalidDataException("cliente is a required property for InvoiceOutputModel and cannot be null");
            }
            else
            {
            ...
            if (firmante == null)
            {
                throw new InvalidDataException("firmante is a required property for InvoiceOutputModel and cannot be null");
            }
            else
            {
            ...
            if (impuestos == null)
            {
                throw new InvalidDataException("impuestos is a required property for InvoiceOutputModel and cannot be null");
            }
            else
            {
            ...
            if (proveedor == null)
            {
                throw new InvalidDataException("proveedor is a required property for InvoiceOutputModel and cannot be null");
            }
            else
            {
            ...
            if (totales == null)
            {
                throw new InvalidDataException("totales is a required property for InvoiceOutputModel and cannot be null");
            }
            else
            {
                this.Totales = totales;
            }
            // to ensure "tipoInvoice" is required (not null)
            if (tipoInvoice == null)
            {
                throw new InvalidDataException("tipoInvoice is a required property for InvoiceOutputModel and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets TipoInvoice
        /// </summary>
        [DataMember(Name="tipoInvoice", EmitDefaultValue=false)]
        public  TipoInvoice { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TipoInvoice: ").Append(TipoInvoice).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as InvoiceOutputModel);
        }

        /// <summary>
        /// Returns true if InvoiceOutputModel instances are equal
        /// </summary>
        /// <param name="input">Instance of InvoiceOutputModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoiceOutputModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TipoInvoice == input.TipoInvoice ||
                    (this.TipoInvoice != null &&
                    this.TipoInvoice.Equals(input.TipoInvoice))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TipoInvoice != null)
                    hashCode = hashCode * 59 + this.TipoInvoice.GetHashCode();
                return hashCode;
            }
        }
