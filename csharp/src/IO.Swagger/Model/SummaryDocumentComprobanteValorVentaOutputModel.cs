...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SummaryDocumentComprobanteValorVentaOutputModel :  IEquatable<SummaryDocumentComprobanteValorVentaOutputModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SummaryDocumentComprobanteValorVentaOutputModel" /> class.
        /// </summary>
        ...
        public SummaryDocumentComprobanteValorVentaOutputModel(TotalValorVentaOutputModel exonerado = default(TotalValorVentaOutputModel), TotalValorVentaOutputModel gratuito = default(TotalValorVentaOutputModel), TotalValorVentaOutputModel gravado = default(TotalValorVentaOutputModel),  importeTotal = default(), TotalValorVentaOutputModel inafecto = default(TotalValorVentaOutputModel),  otrosCargos = default())
        {
            // to ensure "importeTotal" is required (not null)
            if (importeTotal == null)
            {
                throw new InvalidDataException("importeTotal is a required property for SummaryDocumentComprobanteValorVentaOutputModel and cannot be null");
            }
            else
            {
        ...
        public TotalValorVentaOutputModel Exonerado { get; set; }

        /// <summary>
        /// Gets or Sets Gratuito
        /// </summary>
        [DataMember(Name="gratuito", EmitDefaultValue=false)]
        public TotalValorVentaOutputModel Gratuito { get; set; }

        /// <summary>
        /// Gets or Sets Gravado
        /// </summary>
        [DataMember(Name="gravado", EmitDefaultValue=false)]
        public TotalValorVentaOutputModel Gravado { get; set; }
        ...
        public TotalValorVentaOutputModel Inafecto { get; set; }
        ...
        {
            return this.Equals(input as SummaryDocumentComprobanteValorVentaOutputModel);
        }

        /// <summary>
        /// Returns true if SummaryDocumentComprobanteValorVentaOutputModel instances are equal
        /// </summary>
        /// <param name="input">Instance of SummaryDocumentComprobanteValorVentaOutputModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SummaryDocumentComprobanteValorVentaOutputModel input)
        {
            if (input == null)
                return false;
