...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DebitNoteOutputModel :  IEquatable<DebitNoteOutputModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebitNoteOutputModel" /> class.
        /// </summary>
        ...
        public DebitNoteOutputModel( cliente = default(),  detalle = default(), string fechaEmision = default(string),  firmante = default(), string horaEmision = default(string),  impuestos = default(), string moneda = default(string),  proveedor = default(), string serieNumero = default(string),  totales = default(), string descripcionSustentoDeNota = default(string), string serieNumeroComprobanteAfectado = default(string),  tipoDocumentoComprobanteAfectado = default(),  tipoNota = default())
        {
            ...
            if (firmante == null)
            {
                throw new InvalidDataException("firmante is a required property for DebitNoteOutputModel and cannot be null");
            }
            else
            {
            ...
            if (impuestos == null)
            {
                throw new InvalidDataException("impuestos is a required property for DebitNoteOutputModel and cannot be null");
            }
            else
            {
            ...
            if (proveedor == null)
            {
                throw new InvalidDataException("proveedor is a required property for DebitNoteOutputModel and cannot be null");
            }
            else
            {
            ...
            if (totales == null)
            {
                throw new InvalidDataException("totales is a required property for DebitNoteOutputModel and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("tipoDocumentoComprobanteAfectado is a required property for DebitNoteOutputModel and cannot be null");
            }
            else
            {
            ...
            if (tipoNota == null)
            {
                throw new InvalidDataException("tipoNota is a required property for DebitNoteOutputModel and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as DebitNoteOutputModel);
        }

        /// <summary>
        /// Returns true if DebitNoteOutputModel instances are equal
        /// </summary>
        /// <param name="input">Instance of DebitNoteOutputModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebitNoteOutputModel input)
        {
            if (input == null)
                return false;
