...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Direccion :  IEquatable<Direccion>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Direccion" /> class.
        /// </summary>
        ...
        public Direccion(string codigoLocal = default(string), string codigoPais = default(string), string departamento = default(string), string direccion = default(string), string distrito = default(string), string provincia = default(string), string ubigeo = default(string), string urbanizacion = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _Direccion: ").Append(_Direccion).Append("\n");
        ...
        {
            return this.Equals(input as Direccion);
        }

        /// <summary>
        /// Returns true if Direccion instances are equal
        /// </summary>
        /// <param name="input">Instance of Direccion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Direccion input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this._Direccion == input._Direccion ||
                    (this._Direccion != null &&
                    this._Direccion.Equals(input._Direccion))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._Direccion != null)
                    hashCode = hashCode * 59 + this._Direccion.GetHashCode();
